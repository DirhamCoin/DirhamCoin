...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"dirhamcoinaddress\"\n"
            "\nEncrypts a private key corresponding to 'dirhamcoinaddress'.\n"
            "\nArguments:\n"
            "1. \"dirhamcoinaddress\"   (string, required) The dirhamcoin address for the private key (you must hold the key already)\n"
...
Value bip38decrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38decrypt \"dirhamcoinaddress\"\n"
