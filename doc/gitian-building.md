...
git clone https://github.com/dirhamcoin-crypto/dirhamcoin.git
cd dirhamcoin
...
```bash
    ...
    From https://github.com/dirhamcoin-crypto/dirhamcoin
...
[dirhamcoin/gitian.sigs](https://github.com/dirhamcoin-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
