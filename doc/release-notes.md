dirhamcoin Core version 2.2.1 is now available from:

  <https://github.com/dirhamcoin-project/dirhamcoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/dirhamcoin-project/dirhamcoin/issues>

Compatibility
==============

dirhamcoin Core is extensively tested on multiple operating systems using
...
dirhamcoin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that dirhamcoin was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/dirhamcoin-project-translations/).
