...
In order to support loading of multiple wallets in dirhamcoin-qt, a few changes in the UI architecture will be needed.
...
----------------------
dirhamcoin.cpp is the entry point into dirhamcoin-qt, and as such, will require some minor modifications to provide hooks for
