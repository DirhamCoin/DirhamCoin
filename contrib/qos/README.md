...
This means one can have an always-on dirhamcoind instance running, and another local dirhamcoind/dirhamcoin-qt instance which connects to this node and receives blocks from it.
