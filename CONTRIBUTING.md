Contributing to dirhamcoin Core
============================

The dirhamcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the dirhamcoin Core project, and is not to be
confused with overall dirhamcoin Network Protocol consensus changes.

Whether a pull request is merged into dirhamcoin Core rests with the project merge
...
Patches that change dirhamcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the dirhamcoin consensus, it must have been
...
The project leader is the release manager for each dirhamcoin Core release.
